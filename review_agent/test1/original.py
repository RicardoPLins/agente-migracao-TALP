...
class ConversationScraper:
    """Scraper that retrieves, manipulates and stores all messages belonging to a specific Facebook conversation"""
    ...
    def executeRequest(self, requestData):
        ...
        The request headers are generated here.
    ...
    def scrapeConversation(self, merge):
        ...
        If merge is specified, then new messages are merged with the previously scraped conversation.
        """
